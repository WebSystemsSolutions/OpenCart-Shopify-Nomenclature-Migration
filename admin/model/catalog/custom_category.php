...
class ModelCatalogCustomCategory extends Model {
	public function addCategory($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "category SET parent_id = '" . (int)$data['parent_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `home` = '" . (isset($data['home']) ? (int)$data['home'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_modified = NOW(), date_added = NOW()");
        ...
        if (isset($data['shopify_category_id'])) {
            $this->db->query("UPDATE " . DB_PREFIX . "category SET shopify_category_id = '" . $this->db->escape($data['shopify_category_id']) . "' WHERE category_id = '" . (int)$category_id . "'");
        }
	...
	public function editCategory($category_id, $data) {
		...
		$this->db->query("UPDATE " . DB_PREFIX . "category SET parent_id = '" . (int)$data['parent_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `home` = '" . (isset($data['home']) ? (int)$data['home'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_modified = NOW() WHERE category_id = '" . (int)$category_id . "'");
    ...
    public function editCategoryShopifyId($category_id, $data) {
    ...
    public function getCategoriesNameAndId() {
    ...
    public function getCategoriesDescriptionsAll() {
